...
url = 'https://dev32384.service-now.com/api/now/table/incident?sysparm_limit=100'
user = 'admin'
pwd = 'Grape123!'
...
print "This is the state! %s" % data['result'][0]['state']
print len(data['result'])
for i in data['result']:
    print data['result'][c]['description']
    c = c + 1
